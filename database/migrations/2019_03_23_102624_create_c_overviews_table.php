...
class CreateCOverviewsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('c_overviews', function (Blueprint $table) {
            ...
            $table->string('c_full_name', 50);
            $table->string('c_founded', 50);
            $table->string('c_founder', 50);
            $table->string('c_ceo', 50);
            $table->string('c_industry', 50);
            $table->string('c_headquaters', 50);
            $table->string('c_revenue', 50);
            $table->string('c_sector', 50);
