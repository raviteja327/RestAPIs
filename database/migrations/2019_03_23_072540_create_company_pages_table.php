...
class CreateCompanyPagesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('company_pages', function (Blueprint $table) {
            ...
            $table->string('c_page_name', 50);
            $table->string('custom_field', 50);
            $table->string('author', 50);
            $table->string('c_page_description');
            $table->string('c_link_id', 50);
            $table->string('c_news', 100);
            $table->string('c_partners', 100);
            $table->string('c_reference', 100);
            $table->string('c_carreer', 100);
            $table->string('c_contact', 50);
            $table->string('c_overview', 100);
            $table->string('c_location', 50);
